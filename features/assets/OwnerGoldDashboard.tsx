...
import { BackIcon, PlusIcon, EditIcon, DeleteIcon } from '../../components/Icons';
import { saveImageDataURL, getObjectURLByRef } from '../../lib/idb-images';
import { LinkFromRef } from './components/LinkFromRef';
import { OwnerGoldOverview } from './components/OwnerGoldOverview';
...
export function OwnerGoldDashboard({ ownerId, onBack }: { ownerId: string; onBack: () => void; }): React.ReactNode {
    ...
    return (
        <div className="space-y-4 md:space-y-6">
            ...
            {view === 'overview' ? (
                <OwnerGoldOverview phys={phys} tok={tok} dgi={dgi} totalPaid={totals.totalPaid} onSelectView={setView} j={j} />
            ) : (
